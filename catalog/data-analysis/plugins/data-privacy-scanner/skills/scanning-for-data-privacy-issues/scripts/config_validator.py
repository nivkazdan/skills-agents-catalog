#!/usr/bin/env python3
"""
data-privacy-scanner - config_validator.py
Script to validate the configuration files used by the data privacy scanner tool.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to validate the configuration files used by the data privacy scanner tool."
    )
    ...
    print(f"🚀 data-privacy-scanner - config_validator.py")
