#!/usr/bin/env python3
"""
apm-dashboard-creator - get_apm_metrics.py
Retrieves available APM metrics from various platforms (Grafana, Datadog, New Relic).
...
def main():
    parser = argparse.ArgumentParser(
        description="Retrieves available APM metrics from various platforms (Grafana, Datadog, New Relic)."
    )
    ...
    print(f"🚀 apm-dashboard-creator - get_apm_metrics.py")
    print(f"   Category: performance")
    print(f"   Plugin: apm-dashboard-creator")
