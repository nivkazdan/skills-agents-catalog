#!/usr/bin/env python3
"""
database-deadlock-detector - simulate_deadlock.py
Script to simulate a deadlock scenario for testing purposes.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to simulate a deadlock scenario for testing purposes."
    )
    ...
    print(f"🚀 database-deadlock-detector - simulate_deadlock.py")
