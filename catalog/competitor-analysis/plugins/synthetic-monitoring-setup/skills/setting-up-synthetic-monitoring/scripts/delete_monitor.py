#!/usr/bin/env python3
"""
synthetic-monitoring-setup - delete_monitor.py
Removes synthetic monitors that are no longer needed.
...
def main():
    parser = argparse.ArgumentParser(
        description="Removes synthetic monitors that are no longer needed."
    )
    ...
    print(f"🚀 synthetic-monitoring-setup - delete_monitor.py")
