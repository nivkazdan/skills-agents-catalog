#!/usr/bin/env python3
"""
cpu-usage-monitor - cpu_profiler.py
A script to profile CPU usage of a given process and output a detailed report.
...
def main():
    parser = argparse.ArgumentParser(
        description="A script to profile CPU usage of a given process and output a detailed report."
    )
    ...
    print(f"🚀 cpu-usage-monitor - cpu_profiler.py")
