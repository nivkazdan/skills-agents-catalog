#!/usr/bin/env python3
"""
git-commit-smart - git_utils.py
Provides utility functions for interacting with Git (e.g., staging changes, getting diffs).
...
def main():
    parser = argparse.ArgumentParser(
        description="Provides utility functions for interacting with Git (e.g., staging changes, getting diffs)."
    )
    ...
    print(f"🚀 git-commit-smart - git_utils.py")
    print(f"   Category: devops")
    print(f"   Plugin: git-commit-smart")
