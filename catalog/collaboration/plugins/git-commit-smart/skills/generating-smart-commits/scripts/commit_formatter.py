#!/usr/bin/env python3
"""
git-commit-smart - commit_formatter.py
Formats the commit message according to conventional commit standards.
...
def main():
    parser = argparse.ArgumentParser(
        description="Formats the commit message according to conventional commit standards."
    )
    ...
    print(f"🚀 git-commit-smart - commit_formatter.py")
