...
Parses web search results from different search engines, extracting relevant information such as titles, snippets, and URLs.
...
def main():
    parser = argparse.ArgumentParser(
        description="Parses web search results from different search engines, extracting relevant information such as titles, snippets, and URLs."
    )
