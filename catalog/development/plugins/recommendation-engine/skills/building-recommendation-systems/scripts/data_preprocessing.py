#!/usr/bin/env python3
"""
recommendation-engine - data_preprocessing.py
Script to preprocess the user-item interaction data.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to preprocess the user-item interaction data."
    )
    ...
    print(f"🚀 recommendation-engine - data_preprocessing.py")
