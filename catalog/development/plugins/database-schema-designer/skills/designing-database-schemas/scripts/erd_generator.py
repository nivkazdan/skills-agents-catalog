#!/usr/bin/env python3
"""
database-schema-designer - erd_generator.py
Generates a Mermaid ERD diagram from a database schema definition.
...
def main():
    parser = argparse.ArgumentParser(
        description="Generates a Mermaid ERD diagram from a database schema definition."
    )
