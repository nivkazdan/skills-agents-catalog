#!/usr/bin/env python3
"""
query-performance-analyzer - explain_plan_parser.py
Parses EXPLAIN plan output and extracts key metrics.
...
def main():
    parser = argparse.ArgumentParser(
        description="Parses EXPLAIN plan output and extracts key metrics."
    )
    ...
    print(f"🚀 query-performance-analyzer - explain_plan_parser.py")
