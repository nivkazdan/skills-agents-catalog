#!/usr/bin/env python3
"""
load-balancer-tester - config_parser.py
Script to parse load balancer configuration files.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to parse load balancer configuration files."
    )
    ...
    print(f"🚀 load-balancer-tester - config_parser.py")
