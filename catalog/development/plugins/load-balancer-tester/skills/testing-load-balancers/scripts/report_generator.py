#!/usr/bin/env python3
"""
load-balancer-tester - report_generator.py
Script to generate a detailed report of the load balancer test results.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to generate a detailed report of the load balancer test results."
    )
    ...
    print(f"🚀 load-balancer-tester - report_generator.py")
