#!/usr/bin/env python3
"""
api-fuzzer - fuzz_api.py
Script to execute the fuzzing process, taking API endpoint and payload types as input.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to execute the fuzzing process, taking API endpoint and payload types as input."
    )
    ...
    print(f"🚀 api-fuzzer - fuzz_api.py")
